...
class App(customtkinter.CTk):
    ...
    def getVisualization(self):
        if self.dimension <= 3:
            ...
            self.graph = ImageTk.PhotoImage(Image.open("currentPlot.png").resize((int(self.solutionLabel.winfo_height()*1.3), self.solutionLabel.winfo_height()), Image.ANTIALIAS), master=self.solutionLabel)
